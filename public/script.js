document.addEventListener("DOMContentLoaded", () => {
  ...
  async function loadItems() {
    ...
    items.forEach((item) => {
      ...
      card.innerHTML = `
        ...
        <div class="card-buttons">
            ...
            <button class="delete-btn" data-id="${item._id}">Excluir</button>
        </div>
      `;
    ...
    // Editar funcionalidade permanece a mesma
  ...
  form.addEventListener("submit", async (e) => {
    ...
    if (editIndex !== undefined) formData.append("id", editIndex);
